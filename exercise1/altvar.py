...
def altitude_var_g(heigths: np.ndarray) -> np.ndarray:
    ...
    grav_acc = grav_acceleration_at_ground * (earth_radius**2 / (earth_radius + heigths)**2)
...
if __name__ == '__main__':
    ...
    print(altitude_var_g(heigths=heigths_in_m))
